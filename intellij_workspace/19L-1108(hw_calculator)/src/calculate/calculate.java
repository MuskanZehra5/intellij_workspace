...
public class calculate {
    ...
    private void halfbtn(ActionEvent e) {
        // TODO add your code here
        firstnum = Double.parseDouble(input.getText());
        double x = Double.parseDouble(output.getText());
        if(firstnum == x )
            firstnum = x;
    ...
    private void initComponents() {
        ...
        //======== Calculator ========
        {
            var CalculatorContentPane = Calculator.getContentPane();
			...
			modbtn(e);
                ...
                sqrtbtn.addActionListener(e -> sqrtbtn(e));
                panel1.add(sqrtbtn);
			...
			halfbtn(e);
                ...
                cebtn.addActionListener(e -> cebtn(e));
                panel1.add(cebtn);
                ...
                cbtn.addActionListener(e -> cbtn(e));
                panel1.add(cbtn);
                ...
                divbtn.addActionListener(e -> divbtn(e));
                panel1.add(divbtn);
			...
			btn7(e);
                ...
                mulbtn.addActionListener(e -> mulbtn(e));
                panel1.add(mulbtn);
			...
			minusbtn(e);
                ...
                plusbtn.addActionListener(e -> plusbtn(e));
                panel1.add(plusbtn);
                ...
                plusminusbtn.addActionListener(e -> plusminusbtn(e));
                ...
                pointbtn.addActionListener(e -> pointbtn(e));
                panel1.add(pointbtn);
                ...
                equalbtn.addActionListener(e -> equalbtn(e));
                panel1.add(equalbtn);
            }
    ...
    public static void main(String[] args) {
        ...
        frame.setContentPane(new calculate().panel1);
